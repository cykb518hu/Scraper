...
{
    public class RichmondMICity : City
    {
        private List<string> docUrls = null;

        public RichmondMICity()
        {
            cityEntity = new CityInfo()
            {
                CityId = "RichmondMICity",
                CityName = "Richmond",
                CityUrl = "http://www.cityofrichmond.net/",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("RichmondMICity_Urls.txt").ToList();
        }
