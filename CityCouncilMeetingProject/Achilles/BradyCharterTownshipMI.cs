...
{
    public class BradyCharterTownshipMI : City
    {
        private List<string> docUrls = null;

        public BradyCharterTownshipMI()
        {
            cityEntity = new CityInfo()
            {
                CityId = "BradyCharterTownshipMI",
                CityName = "Brady Charter Township",
                CityUrl = "https://bradytwpmi.documents-on-demand.com",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("BradyCharterTownshipMI_Urls.txt").ToList();
        }
        ...
        public List<FileNameAndUrl> GetFilesList(string folderId)
        {
            ...
            var url = string.Format("https://bradytwpmi.documents-on-demand.com/Mod/JsonDisplaySubFolders?FolderId={0}", folderId);
            ...
            if (data != null && data.Data.Children.Any())
            {
                foreach (var r in data.Data.Children)
                {
                    ...
                    {
                        var fileUrl = string.Format("https://bradytwpmi.documents-on-demand.com/MOD/JsonDisplayFolderDocuments/?FolderId={0}&Key={1}", folderId, r.Data.Title);
