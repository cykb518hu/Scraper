...
{
    public class StockbridgeCharterTownshipMI : City
    {
        private List<string> docUrls = null;

        public StockbridgeCharterTownshipMI()
        {
            cityEntity = new CityInfo()
            {
                CityId = "StockbridgeCharterTownshipMI",
                CityName = "Stockbridge Charter Township",
                CityUrl = "http://worthmi.org",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("WorthCharterTownshipMI_Urls.txt").ToList();
        }
