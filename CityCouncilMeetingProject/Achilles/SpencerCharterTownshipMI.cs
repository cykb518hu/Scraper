...
{
    public class SpencerCharterTownshipMI : City
    {
        private List<string> docUrls = null;

        public SpencerCharterTownshipMI()
        {
            cityEntity = new CityInfo()
            {
                CityId = "SpencerCharterTownshipMI",
                CityName = "Spencer Charter Township",
                CityUrl = "http://www.spencertwp.org/",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("SpencerCharterTownshipMI_Urls.txt").ToList();
        }
