...
{
    public class AlmontVillageMI : City
    {
        private List<string> docUrls = null;

        public AlmontVillageMI()
        {
            cityEntity = new CityInfo()
            {
                CityId = "AlmontVillageMI",
                CityName = "Almont",
                CityUrl = "http://www.almontmichigan.gov/1/324/index.asp",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("AlmontVillageMI_Urls.txt").ToList();
        }
                ...
                foreach (string url in this.docUrls)
                {
                    ...
                    if (fileTokens != null)
                    {
                        foreach (var fileToken in fileTokens)
                        {
                            ...
                            string fileUrl = "https://almontvillagemi.documents-on-demand.com" + fileToken.SelectToken("$..href").ToString();
