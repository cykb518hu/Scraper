...
{
    public class DundeeVillageMI : City
    {
        private List<string> docUrls = null;

        public DundeeVillageMI()
        {
            cityEntity = new CityInfo()
            {
                CityId = "DundeeVillageMI",
                CityName = "Dundee Village",
                CityUrl = "http://www.dundeevillage.net",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("DundeeVillageMI_Urls.txt").ToList();
        }
