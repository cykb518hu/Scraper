...
{
    public class AuburnHillsMICity : City
    {
        private List<string> docUrls = null;

        public AuburnHillsMICity()
        {
            cityEntity = new CityInfo()
            {
                CityId = "AuburnHillsMICity",
                CityName = "Auburn Hills",
                CityUrl = "http://www.auburnhills.org/",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("AuburnHillsMICity_Urls.txt").ToList();
        }
                ...
                foreach (string url in this.docUrls)
                {
                    ...
                    if (fileTokens != null)
                    {
                        foreach (var fileToken in fileTokens)
                        {
                            ...
                            string fileUrl = "https://auburnhillscitymi.documents-on-demand.com" + fileToken.SelectToken("$..href").ToString();
