...
{
    public class BrandonTownshipMI : City
    {
        private List<string> docUrls = null;
        
        public BrandonTownshipMI()
        {
            cityEntity = new CityInfo()
            {
                CityId = "BrandonTownshipMI",
                CityName = "Brandon Township",
                CityUrl = "http://www.brandontownship.us/",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("BrandonTownshipMI_Urls.txt").ToList();
        }
                ...
                foreach (string url in this.docUrls)
                {
                    ...
                    if (fileTokens != null)
                    {
                        foreach (var fileToken in fileTokens)
                        {
                            ...
                            string fileUrl = "https://brandontwpmi.documents-on-demand.com" + fileToken.ToString();
