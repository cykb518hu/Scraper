...
{
    public class HagarTownshipMI : City
    {
        private List<string> docUrls = null;

        public HagarTownshipMI()
        {
            cityEntity = new CityInfo()
            {
                CityId = "HagarTownshipMI",
                CityName = "Hagar",
                CityUrl = "http://www.hagartownship.org",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("HagarTownshipMI_Urls.txt").ToList();
        }
                ...
                foreach (string url in this.docUrls)
                {
                    ...
                    if (fileTokens != null)
                    {
                        foreach (var fileToken in fileTokens)
                        {
                            ...
                            string fileUrl = "https://hagartwpmi.documents-on-demand.com" + fileToken.SelectToken("$..href").ToString();
