...
{
    public class ZeelandMICity : City
    {
        private List<string> docUrls = null;

        public ZeelandMICity()
        {
            cityEntity = new CityInfo()
            {
                CityId = "ZeelandMICity",
                CityName = "Zeeland",
                CityUrl = "http://www.ci.zeeland.mi.us",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("ZeelandMICity_Urls.txt").ToList();
        }
