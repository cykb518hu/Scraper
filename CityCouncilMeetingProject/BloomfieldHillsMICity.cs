...
{
    public class BloomfieldHillsMICity : City
    {
        private List<string> docUrls = null;

        public BloomfieldHillsMICity()
        {
            cityEntity = new CityInfo()
            {
                CityId = "BloomfieldHillsMICity",
                CityName = "Bloomfield Hills",
                CityUrl = "http://www.bloomfieldhillsmi.net",
                StateCode = "MI"
            };
            ...
            this.docUrls = File.ReadAllLines("BloomfieldHillsMICity_Urls.txt").ToList();
        }
                ...
                foreach (string url in this.docUrls)
                {
                    ...
                    if (fileTokens != null)
                    {
                        foreach(var fileToken in fileTokens)
                        {
                            ...
                            string fileUrl = "https://bloomfieldhillscitymi.documents-on-demand.com" + fileToken.ToString();
